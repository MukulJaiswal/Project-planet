       ...
       <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="signup/login.html">Login</a>
            </li>
      ...
      <div class="container">
        <div class="row">
          ...
          <a href="branch/cse/cse.html" >  <img src=img/cs.jpg  width="270px" height="200px"  class="img-thumbnail>
              ...
              <p class="text-muted" class="bg-success" style="padding: 10px;" align="center">Computer Science Engineering</p></a>
            </div>
          </div>
  ...
  <section class="bg-primary" id="chatbox">
      <div class="container">
        <div class="row">
          ...
          <iframe width="400" height="360" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" allowtransparency="true" src="https://chatroll.com/embed/chat/eci5?id=xiJFGHdDKDZ&platform=html"></iframe>
